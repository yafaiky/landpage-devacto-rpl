      ...
      <div className="footer__inner">
        <div className="footer__top">
          ...
          <div>
            ...
            <a href="#" className="footer__col-link">GitHub</a>
            <a href="#" className="footer__col-link">Documentation</a>
            <a href="#" className="footer__col-link">Tech Blog</a>
            <a href="#" className="footer__col-link">Open Source</a>
          </div>

          <div>
            <h4 className="footer__col-title">Company</h4>
            <a href="#" className="footer__col-link">About Us</a>
            <a href="#" className="footer__col-link">LinkedIn</a>
        ...
        <div className="footer__bottom">
          <p className="footer__copy">
            © {new Date().getFullYear()} Software Engineering. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
